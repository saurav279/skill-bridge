...
import { isConsultationPackageId } from "@/data/consultation-packages";

export const metadata: Metadata = {
  title: "Payment cancelled",
  description: "Your consultation checkout was cancelled. You can pick a time and try again.",
};
      ...
      <div className="container-page">
        <div className="mx-auto max-w-lg rounded-2xl border border-border/80 bg-card p-8 text-center shadow-soft sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-muted-foreground sm:text-base">
            No charge was made. You can return to the booking page, pick a time,
